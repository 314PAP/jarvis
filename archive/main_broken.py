...
import subprocess
import webbrowser
impor                # Použij přesně hodnoty z config - NE max()!
                ...
                self.recognizer.pause_threshold = 1.0b.parse
...
class MyJarvis:
    ...
    def generate_ai_response(self, text):
        ...
        try:
            ...
            # Český prompt s lepší instrukcí
            prompt = f"""Odpověz česky na otázku krátce a přesně: {text}
                    ...
                    if self.detect_wake_word():
                        ...
                        if command:
                            ...
                            if sys_result is True:
                                ...
                                logger.info("👂 Čekám na wake word: '%s'", self.config["wake_word"]["keyword"])
                                continue
